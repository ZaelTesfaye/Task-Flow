...
*/
-- DropForeignKey
ALTER TABLE "PendingUpdates" DROP CONSTRAINT "PendingUpdates_updateBy_fkey";

-- DropForeignKey
ALTER TABLE "Project" DROP CONSTRAINT "Project_ownerId_fkey";

-- DropForeignKey
ALTER TABLE "ProjectInvitation" DROP CONSTRAINT "ProjectInvitation_inviteeId_fkey";
...
-- AddForeignKey
ALTER TABLE "PendingUpdates" ADD CONSTRAINT "PendingUpdates_updateBy_fkey" FOREIGN KEY ("updateBy") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
