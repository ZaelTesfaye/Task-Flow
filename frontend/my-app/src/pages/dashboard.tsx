...
export default function Dashboard() {
  ...
  const fetchProjects = async () => {
    try {
      ...
      setProjects(response.data.data || { owner: [], admin: [], member: [] });
    } catch (error) {
        ...
        <div className="space-y-8">
          ...
          {activeView === 'all' ? (
            <>
              ...
              {projects.owner.length > 0 && (
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className="px-3 py-1 rounded-full bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 text-sm font-semibold">
              ...
              {/* Show create card when no projects exist */}
              {allProjects.length === 0 && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <form onSubmit={handleCreateProject} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="flex w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:ring-offset-gray-900 transition-all resize-none"
