...
import { LogOut, Settings, Trash2, Moon, Sun } from 'lucide-react';
        ...
        <div className="px-6 py-4 flex items-center justify-between">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg px-3 py-2 transition"
            >
            ...
            {showProfileMenu && (
              <div ref={profileMenuRef} className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2">
                <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Your User ID</p>
                  <div className="flex items-center gap-2">
                    <code className="text-xs bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded flex-1 overflow-hidden text-ellipsis">
                      {user.id}
                    </code>
                    <button
                      onClick={() => {
