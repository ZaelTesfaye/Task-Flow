      ...
      <div
        className={`p-2 rounded-lg border cursor-pointer transition-colors ${
          task.assignedTo === currentUserId
            ...
            : "bg-gray-100 dark:bg-gray-900/50 border-[hsl(var(--border))] hover:bg-gray-200 dark:hover:bg-gray-800/50"
        }`}
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            {/* Description */}
            {task.description && (
              <p className="text-xs text-[hsl(var(--muted-foreground))] line-clamp-2 mb-2 pl-6">
                {task.description}
              </p>
            )}
